...
class SettingsProvider extends ChangeNotifier {
  ...
  /// Force NavProMini launch/topic defaults (same robot for all users of this PC app).
  /// Preserves bookmarks and missions.
  Future<void> applyNavProMiniDefaults({bool notify = true}) async {
    _cmdVelTopic = DefaultSettings.cmdVelTopic;
    _linearVelocity = DefaultSettings.defaultLinearVelocity;
    _angularVelocity = DefaultSettings.defaultAngularVelocity;
    _twistType = DefaultSettings.defaultTwistType;
    _mapsPath = DefaultSettings.defaultMapsFolder;
    _mappingLaunchFile = DefaultSettings.defaultMappingLaunchFile;
    _mappingOdomTopic = DefaultSettings.defaultMappingOdomTopic;
    _mappingOdomTopicType = DefaultSettings.defaultMappingOdomTopicType;
    _mappingArgs = DefaultSettings.defaultMappingArgs
        .map((e) => Map<String, String>.from(e))
        .toList();
    _saveMapLaunchFile = DefaultSettings.defaultSaveMapLaunchFile;
    _navigationLaunchFile = DefaultSettings.defaultNavigationLaunchFile;
    _navigationOdomTopic = DefaultSettings.defaultNavigationOdomTopic;
    _navigationOdomTopicType = DefaultSettings.defaultNavigationOdomTopicType;
    _navigationArgs = DefaultSettings.defaultNavigationArgs
        .map((e) => Map<String, String>.from(e))
        .toList();
    _cameraImageTopic = DefaultSettings.defaultCameraTopic;
    _cameraEnabled = false;
    _odomTopic = DefaultSettings.defaultOdomTopic;
    _odomTopicType = DefaultSettings.defaultOdomTopicType;
    _lidarTopic = DefaultSettings.defaultLidarTopic;
    ...
    _odomFrame = DefaultSettings.defaultOdomFrame;
    _baseLinkFrame = DefaultSettings.defaultBaseLinkFrame;
    await _saveSettings();
  ...
  Future<void> _loadSettings() async {
    ...
    // Always lock robot configuration to NavProMini (bookmarks/missions kept)
    await applyNavProMiniDefaults(notify: false);
    notifyListeners();
  }
