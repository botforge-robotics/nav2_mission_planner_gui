...
class PathTopicInput extends StatefulWidget {
  final String initialValue;
  final Function(String) onChanged;
  final Size screenSize;
  final Color modeColor;

  const PathTopicInput({
    super.key,
  ...
  @override
  State<PathTopicInput> createState() => _PathTopicInputState();
}

class _PathTopicInputState extends State<PathTopicInput> {
  ...
  Future<void> _fetchTopics() async {
    ...
    try {
      ...
      final response =
          await client.call(TopicsForTypeRequest(type: 'nav_msgs/msg/Path'));
