...
class LaunchWithArgsRequest extends RosMessage<LaunchWithArgsRequest> {
  ...
  LaunchWithArgsRequest({String? package, String? launch_file, String? arguments})
      : package = package ?? '',
        launch_file = launch_file ?? '',
        arguments = arguments ?? '';

  @override
  String get fullType => 'navpromini_launch_manager_interfaces/srv/LaunchWithArgs_Request';
...
string arguments''';
  ...
  @override
  Map<String, dynamic> toJson() => {'package': package, 'launch_file': launch_file, 'arguments': arguments};
...
class LaunchWithArgsResponse extends RosMessage<LaunchWithArgsResponse> {
  ...
  @override
  String get fullType => 'navpromini_launch_manager_interfaces/srv/LaunchWithArgs_Response';
...
string unique_id''';
  ...
  @override
  Map<String, dynamic> toJson() => {'success': success, 'message': message, 'unique_id': unique_id};
  ...
  LaunchWithArgsResponse fromJson(Map<String, dynamic> jsonMap) {
    final successVal = jsonMap['success'];
    final success = successVal == true || successVal == 1 || successVal?.toString().toLowerCase() == 'true';
    return LaunchWithArgsResponse(
      success: success,
      message: jsonMap['message']?.toString() ?? '',
      unique_id: jsonMap['unique_id']?.toString() ?? '',
    );
  }
}

class LaunchWithArgs extends RosServiceMessage<LaunchWithArgsRequest, LaunchWithArgsResponse> {
  @override
  ...
  @override
  String get fullType => 'navpromini_launch_manager_interfaces/srv/LaunchWithArgs';
